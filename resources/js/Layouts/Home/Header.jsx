...
export default function Header({ auth, mustVerifyEmail, status, waktu, fajr, Sunrise, Dhuhr, Asr, Maghrib, Isha }) {
    ...
    return (
             ...
             <div className="absolute top-0 left-0 right-0">
                <div className="bg-transparent p-4">
                    ...
                    className={`flex  flex-col items-start mt-2 z-50 space-y-2 max-[768px]:flex transition-all duration-300 ease-in-out ${
                        isOpen ? 'opacity-100 min-[768px]:hidden max-h-full   bg-white rounded-lg' : 'opacity-0 max-h-0'
                    }`}
        ...
        <div className={`container mx-auto fixed top-0 left-0 right-0 transition-all duration-500     ${scrolling ? 'backdrop-blur-sm' : 'bg-transparent mt-16'}`}>        
        <div className=" mx-auto  ">
            <nav className={`py-3 transition-all duration-500 ${scrolling ? 'backdrop-blur-sm' : 'bg-transparent'}`}>
                    <div className="flex justify-between items-center">
                        ...
                        <div className="hidden lg:flex lg:items-center lg:space-x-4">
                            ...
                            <a href="activity.html" className="text-gray-700">Activities</a>
                            <a href="event.html" className="text-gray-700">Events</a>
                            <a href="sermon.html" className="text-gray-700">Sermons</a>
                            <div className="relative group">
                                ...
                                <div className="absolute hidden group-hover:block bg-white shadow-lg rounded mt-2">
                                    <a href="blog.html" className="block px-4 py-2 text-gray-700">Latest Blog</a>
                                    <a href="team.html" className="block px-4 py-2 text-gray-700">Our Team</a>
                                    <a href="testimonial.html" className="block px-4 py-2 text-gray-700">Testimonial</a>
                                    <a href="404.html" className="block px-4 py-2 text-gray-700">404 Page</a>
                                </div>
                            </div>
                        ...
                        <a href="#" className="bg-primary rounded-lg text-white py-2 px-4 ">Donate</a>
                    </div>
                </nav>
            </div>
        </div>
