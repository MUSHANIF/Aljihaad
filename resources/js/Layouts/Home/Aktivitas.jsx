            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-white p-6 rounded-lg shadow-lg">
                    <div className="flex mt-4 gap-5">
                        ...
                        <p className="mt-2 text-gray-600">Lorem ipsum dolor sit amet elit. Donec tempus eros vel dolor mattis aliquam.</p>
                        <a href="#" className="mt-4 inline-block bg-primary text-white py-2 px-4 rounded-lg transition duration-300 hover:bg-primary-dark">Read More</a>
                        </div>
                    </div>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-lg">
