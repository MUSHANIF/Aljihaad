...
<body>
    <div class="header">TANDA TERIMA ZAKAT ZAKAT MUSHOLLA ALJIHAAD</div>
    <div class="content">
        <div class="invoice-container">
            ...
            <div class="invoice-item">
                <strong>Nama:</strong> {{ $invoice['nama'] }}
            </div>
            <div class="invoice-item">
        ...
        <p>
            Sejumlah <strong><s>UANG</s></strong> /
            <strong>BERAS</strong>
            untuk pembayaran <strong>{{ $invoice['jenis'] }}</strong> sebesar Rp ..... / {{ $invoice['beras'] }} Liter
        ...
        <p>
            ...
            apa saja yang telah engkau berikan..."
        </p>
    </div>
    <div class="footer">
        <div class="subfooter">
